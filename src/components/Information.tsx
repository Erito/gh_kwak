    ...
    return (
        <>
            ...
            <section className="py-20 px-6 relative overflow-hidden">
                ...
                <div className="relative mx-auto flex flex-row items-center justify-between gap-4 py-16 px-8 md:px-20 w-full">
                    <h2 className="flex text-3xl md:text-4xl font-light text-white">
                        Found a <br />
                        <span className="font-black ml-2 text-[#F5C800]">Roadblock</span>?
                    </h2>
                        ...
                        {[
                            ...
                            >
                                <div
                                    ...
                                    className="bg-white rounded-tl-[20px] rounded-br-[20px] p-4 md:p-6 flex flex-col items-end shadow-sm border-6 border-[#F5C800]/30 relative z-10 drop-shadow-none hover:drop-shadow-[0_0_16px_rgba(245,200,0,0.5)] transition-all duration-300"
                                >
            ...
            {/* ── REPORT when you see… ── */}
            <section className="bg-[#383838] px-6 py-20">
                    ...
                    <div className="grid grid-cols-3 gap-4 md:gap-5">
                        {ITEMS.map(({ label, src }) => (
                            ...
                            >
                                ...
                                />
                                <span className="absolute bottom-4 left-4 text-white text-base md:text-lg font-black drop-shadow-lg leading-snug whitespace-pre-line">
                                    {label}
                                </span>
                            </div>
                        ))}
            ...
            <section className="bg-[#383838] pt-8 py-12 w-full text-center">
                <Link
                    to="/report"
                    className="inline-block px-6 py-3 md:px-8 md:py-4 bg-[#F5C800] text-slate-900 font-semibold shadow-md hover:bg-[#e0b800] transition-all rounded-full duration-300 drop-shadow-none hover:drop-shadow-[0_0_16px_rgba(245,200,0,0.5)]"
                >
                    Start Reporting!
                </Link>
            </section>
